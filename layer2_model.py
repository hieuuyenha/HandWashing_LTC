...
class SecondLayerModel:
    def __init__(self, model_type, max_iter, activation_type, solver_type):
        ...
        self.result_pathpredict = os.path.join("results", "logs", SAVE_LOCATION_NAME, f"{LAYER_2_MODEL_TYPE}_{LAYER2_EPOCH_NUM}_resultPredict.txt")
    ...
    def evaluate(self, data):
        ...
        with open(self.result_pathpredict,"w") as f:
